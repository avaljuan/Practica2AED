...
grafico4 <- grafico3 + labs(title = "Probabilidad de lluvia según condiciones meteorológicas", subtitle = "Relación entre temperatura y presión atmosférica a las 9 AM") 
